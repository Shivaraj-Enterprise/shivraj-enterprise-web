    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-shivraj-900 via-shivraj-800 to-shivraj-900 text-white py-20">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/10 backdrop-blur ring-2 ring-white/20 mb-4">
            <MapPin size={32} />
          </div>
          <BlurText as="h1" text="Our Service Areas" className="text-3xl md:text-5xl font-bold mb-4" />
