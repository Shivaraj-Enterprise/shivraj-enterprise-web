      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        >
          <div className="bg-white rounded-full p-3 shadow-2xl shadow-shivraj-500/40 ring-2 ring-white/20">
            <img src={logo} alt="Shivraj Enterprise manpower and housekeeping services logo" width={48} height={48} loading="eager" decoding="async" className="h-12 w-12 object-contain" />
          </div>
        </motion.div>
